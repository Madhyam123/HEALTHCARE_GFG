...
const Navbar = () => {
        ...
        return (
            <div className='w-screen h-[80px] z-10 dark:bg-black bg-zinc-200 fixed drop-shadow-lg'>
                <div className='flex items-center justify-between w-full h-full px-2'>
                    <div className='flex items-center'>
                        <h1 className='mr-4 text-3xl font-bold sm:text-4xl dark:text-white'>BRAND.</h1>
                        <ul className='hidden md:flex'>
                            <li className='transition duration-300 ease-in-out delay-150 cursor-pointer hover:-translate-y-1 hover:scale-110 hover:text-indigo-500 hover:text-lg dark:text-white'><Link to="home" smooth={true} duration={500}>Home</Link></li>
          ...
          <button className='mr-4 text-black bg-transparent border-none dark:text-white'>
           <LinkRouter to = '/Company'>Sign in</LinkRouter>
          </button>
